...
banner() {
  clear
  echo ""
  echo -e "${G}  _______                                                                  ______${N}"
  echo -e "${G} /_  __/______   _____ ________    __  __ ______  ______  ____       _____ /_  __/${N}"
  echo -e "${G}  / / / _____ \ / ___// __ \ __\  / / / // ____/ / ____/ / /\ \     / ___/  / /${N}"
  echo -e "${G} / / / /______// /   / / / / / / / /_/ // /__   / /     / /__\ \   / ___/  / /${N}"
  echo -e "${G}/_/  \\___ /  /_/   /_/ /_/ /_/  \___,/ \____/ /_/     / /    \ \_/_/     / /${N}"
